...
Groundwork is a Claude Code plugin that provides a skills library for structured development workflows. It contains 28 skills and 22 commands for planning, TDD, debugging, and synchronization.
