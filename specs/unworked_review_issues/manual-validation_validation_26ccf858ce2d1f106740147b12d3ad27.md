...
3. [ ] **coordinator** | `bin/groundwork-run.js:53` | code-smell
...
4. [ ] **coordinator** | `bin/groundwork-run.js:832` | code-smell
...
7. [ ] **coordinator** | `lib/atomic-write.js:62` | code-readability
...
8. [ ] **coordinator** | `lib/atomic-write.js:65` | needless-repetition
...
9. [ ] **coordinator** | `lib/owned-lock.js:119` | naming
...
10. [ ] **coordinator** | `lib/owned-lock.js:86` | insecure-design
...
11. [ ] **coordinator** | `lib/process-identity.js:25` | resource-leak
...
12. [ ] **coordinator** | `lib/project-context.js:600` | needless-repetition
...
13. [ ] **coordinator** | `lib/validation-session.js:171` | code-structure
...
14. [ ] **coordinator** | `lib/validation-session.js:594` | readability
...
15. [ ] **coordinator** | `pi-extension/lib/project-context-core.js:103` | needless-repetition
...
16. [ ] **coordinator** | `tests/groundwork-run.test.js:1450` | implementation-coupling
...
17. [ ] **coordinator** | `tests/groundwork-run.test.js:7180` | missing-test
...
18. [ ] **coordinator** | `tests/pi-extension.test.js:263` | logic-in-test
...
19. [ ] **coordinator** | `tests/project-context.test.js:1304` | implementation-coupling
...
20. [ ] **coordinator** | `tests/skills-core.test.js:1` | missing-test
...
21. [ ] **coordinator** | `tests/validation-session.test.js:1171` | missing-test
...
22. [ ] **coordinator** | `tests/validation-session.test.js:1222` | implementation-coupling
