...
**Total:** 33 (0 critical, 0 major, 33 minor)

1. [ ] **code-quality-reviewer** | `lib/atomic-write.js:62` | code-readability
...
2. [ ] **code-quality-reviewer** | `lib/validation-session.js:594` | readability
...
3. [ ] **code-quality-reviewer** | `lib/validation-session.js:609` | error-handling
...
4. [ ] **code-quality-reviewer** | `tests/validation-session.test.js:1107` | test-quality
...
5. [ ] **code-simplifier** | `bin/groundwork-run.js:1411` | code-smell
...
6. [ ] **code-simplifier** | `bin/groundwork-run.js:53` | code-smell
...
7. [ ] **code-simplifier** | `bin/groundwork-run.js:832` | code-smell
...
8. [ ] **code-simplifier** | `lib/atomic-write.js:65` | needless-repetition
...
9. [ ] **code-simplifier** | `lib/owned-lock.js:119` | naming
...
10. [ ] **code-simplifier** | `lib/project-context.js:600` | needless-repetition
...
11. [ ] **code-simplifier** | `lib/validation-session.js:1132` | code-structure
...
12. [ ] **code-simplifier** | `lib/validation-session.js:171` | code-structure
...
13. [ ] **code-simplifier** | `lib/validation-session.js:435` | code-smell
...
14. [ ] **code-simplifier** | `pi-extension/lib/project-context-core.js:103` | needless-repetition
...
15. [ ] **housekeeper** | `AGENTS.md:131` | documentation-stale
...
16. [ ] **performance-reviewer** | `bin/groundwork-run.js:1001` | blocking-io
...
17. [ ] **performance-reviewer** | `bin/groundwork-run.js:1408` | blocking-io
...
18. [ ] **performance-reviewer** | `hooks/pin-session-selection.sh:24` | blocking-io
...
19. [ ] **performance-reviewer** | `lib/process-identity.js:25` | resource-leak
...
20. [ ] **security-reviewer** | `hooks/pin-session-selection.sh:51` | injection
...
21. [ ] **security-reviewer** | `lib/owned-lock.js:86` | insecure-design
...
22. [ ] **security-reviewer** | `lib/validation-session.js:1217` | sensitive-data-exposure
...
23. [ ] **security-reviewer** | `lib/validation-session.js:659` | cryptographic-failures
...
24. [ ] **spec-alignment-checker** | `lib/validation-session.js:768` | specification-gap
...
25. [ ] **test-quality-reviewer** | `tests/groundwork-run.test.js:1450` | implementation-coupling
...
26. [ ] **test-quality-reviewer** | `tests/groundwork-run.test.js:7180` | missing-test
...
27. [ ] **test-quality-reviewer** | `tests/pi-extension.test.js:263` | logic-in-test
...
28. [ ] **test-quality-reviewer** | `tests/project-context.test.js:1304` | implementation-coupling
...
29. [ ] **test-quality-reviewer** | `tests/skills-core.test.js:1` | missing-test
...
30. [ ] **test-quality-reviewer** | `tests/validation-session.test.js:1122` | non-deterministic
...
31. [ ] **test-quality-reviewer** | `tests/validation-session.test.js:1171` | missing-test
...
32. [ ] **test-quality-reviewer** | `tests/validation-session.test.js:1222` | implementation-coupling
...
33. [ ] **test-quality-reviewer** | `tests/validation-session.test.js:760` | non-deterministic
