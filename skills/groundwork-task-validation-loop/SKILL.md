---
name: groundwork-task-validation-loop
...
|-------------------------|-------------------|
| `the prd-task-alignment-checker agent` | task_list, product_specs |
| `the architecture-task-alignment-checker agent` | task_list, architecture |
| `the design-task-alignment-checker agent` | task_list, design_system |
