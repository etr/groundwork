---
name: groundwork-test-driven-development
...
**Test-quality standard:** Write tests to the same bar they'll be judged against. `<skill-directory>/references/checklists/testing.md` is the canonical test-quality checklist — pyramid, DAMP, mocking gates, what not to test, coverage. This skill is the *workflow*; that file is the *standard* (the `test-quality-reviewer` agent grades against it).
...
Canonical criteria — test pyramid, the four pillars, coverage completeness — live in `<skill-directory>/references/checklists/testing.md`. Highlights:
