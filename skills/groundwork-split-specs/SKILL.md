...
- **Automatically** by `design-product` and `source-product-specs-from-code` when the single-file PRD crosses **500 lines** or **15 features** (feature sections matching `### \d+\.\d+`)
- **Manually** when the user invokes `/groundwork-split-specs`
