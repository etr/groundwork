...
- `Skill: skill-name`
- `/groundwork:skill-name` (unless the skill is `user-invocable: false`)
...
| Skill | Description |
|-------|-------------|
| `design-product` | Use when defining product requirements |
| `design-architecture` | Use when designing technical approach |
| `create-tasks` | Use when generating implementation tasks |
