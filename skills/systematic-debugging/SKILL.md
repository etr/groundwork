...
1. **Create Failing Test Case**
   ...
   - Use the `groundwork:test-driven-development` skill for writing proper failing tests
...
```
1. Check if it fails locally (same environment?)
2. Compare CI environment with local
3. Check for missing env vars, secrets, dependencies
4. Add diagnostic logging at each build step
5. Verify cache state and artifact paths
```
...
**Related skills:**
- **groundwork:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **groundwork:verification-before-completion** - Verify fix worked before claiming success
