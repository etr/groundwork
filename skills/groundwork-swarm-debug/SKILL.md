...
description: Start swarm debugging with parallel hypothesis investigation.
---
...
3. Follow the groundwork-debug workflow steps and continue with its standard Phase 3 (sequential hypothesis testing)
