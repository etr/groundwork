---
name: help-with-groundwork
description: This skill should be used when the user asks for help with Groundwork - lists all available commands, skills, and agents
