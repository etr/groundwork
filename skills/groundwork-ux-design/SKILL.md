...
description: Create design system with foundations, brand identity, and UX patterns.
---
...
**Accessibility standard:** Design to the bar your patterns will be reviewed against. Treat `<skill-directory>/references/checklists/accessibility.md` as the WCAG 2.1 AA standard your color choices, components, focus behavior, and patterns must meet — the same checklist `design-consistency-checker` enforces.

**Anti-slop standard:** Real content or clearly-labeled placeholders, working controls, and no unreasoned default shapes. Treat `<skill-directory>/references/checklists/design-slop.md` as the catalog of fabricated-content and default-shape patterns the design system must steer implementations away from — the same checklist `design-consistency-checker` reviews against.
...
- **Use Ask the user tool** - When asking the user questions, always use the Ask the user tool with appropriate options
...
2. **CWD mismatch check (monorepo only):**
   ...
   - If CWD is inside a different project's path → warn via `Ask the user`:
...
3. **Check `{{specs_dir}}/`:** Does a specs directory exist?
   ...
   - If no → Ask the user: "Is this a single-project repo or a monorepo with multiple projects?"
     ...
     - **Monorepo** → Follow the groundwork-setup-repo workflow steps to create `.groundwork.yml`, then continue.
...
See `<skill-directory>/references/design-system/spatial-design-guide.md` for full spatial system rationale (4pt grid, optical adjustments, container queries).
...
See `<skill-directory>/references/design-system/color-and-contrast-guide.md` for dangerous color combinations, dark mode strategy, and the two-layer token approach.
...
- **Fewer sizes, more contrast:** A 5-size system with clear visual steps beats 8 muddy-close sizes. Use a modular scale ratio (1.25 major third, 1.333 perfect fourth) — see `<skill-directory>/references/design-system/typography-examples.md`.
...
See `<skill-directory>/references/design-system/typography-guide.md` for OpenType features, dark mode typography adjustments, and font selection anti-patterns.
...
See `<skill-directory>/references/design-system/ux-writing-guide.md` for the full UX writing framework.
...
See `<skill-directory>/references/design-system/motion-design-guide.md` for perceived performance techniques, grid-template-rows height animation, and the 80ms perception threshold.
...
See `<skill-directory>/references/design-system/interaction-design-guide.md` for roving tabindex, skip links, native dialog/popover usage, and gesture discoverability.
...
See `<skill-directory>/references/design-system/layout-architecture-guide.md` for the full pattern library (~35 patterns with CSS/JS implementation) and `<skill-directory>/references/design-system/layout-examples.md` for 7 curated strategy bundles showing how patterns combine.
...
Create `{{specs_dir}}/design_system.md` using template in `<skill-directory>/references/design-system/design-system-template.md`.
...
- **Design architecture**: Follow the workflow steps in skill `groundwork-design-architecture` to design the technical approach
...
- `<skill-directory>/references/design-system/design-system-template.md` - Template for design system document
- `<skill-directory>/references/design-system/color-examples.md` - Color strategy approaches and reference palettes
- `<skill-directory>/references/design-system/color-and-contrast-guide.md` - OKLCH, tinted neutrals, dark mode strategy, dangerous color combinations
- `<skill-directory>/references/design-system/typography-examples.md` - Example type systems and font pairings
- `<skill-directory>/references/design-system/typography-guide.md` - Vertical rhythm, fluid type, font loading, OpenType features
- `<skill-directory>/references/design-system/pattern-examples.md` - Example UX patterns
- `<skill-directory>/references/design-system/interaction-design-guide.md` - Eight states, focus management, touch targets, native elements
- `<skill-directory>/references/design-system/motion-design-guide.md` - Timing rules, easing, perceived performance, reduced motion
- `<skill-directory>/references/design-system/spatial-design-guide.md` - 4pt grid, semantic tokens, container queries, optical adjustments
- `<skill-directory>/references/design-system/ux-writing-guide.md` - Button labels, error formulas, empty states, terminology, text expansion
- `<skill-directory>/references/design-system/layout-architecture-guide.md` - Section geometry, scroll architecture, navigation, content choreography, typography as architecture (~35 patterns)
- `<skill-directory>/references/design-system/layout-examples.md` - 7 curated strategy bundles combining layout patterns into coherent layouts
