 ...
 */
function routePRDContent(content, baseDir = getProjectRoot()) {
 ...
 * @returns {{path: string, type: 'file'|'directory', isNew: boolean, reason: string}}
 */
function routeArchitectureContent(content, baseDir = getProjectRoot()) {
 ...
 * @returns {{path: string, type: 'file'|'directory', isNew: boolean, reason: string}}
 */
function routeTasksContent(content, baseDir = getProjectRoot()) {
 ...
 * @returns {{path: string, type: 'file'|'directory', isNew: boolean, reason: string}}
 */
function routeContent(specName, content, baseDir = getProjectRoot()) {
