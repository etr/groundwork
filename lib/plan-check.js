 ...
 *     ## Context
 *     - Identifier: TASK-004
 *     - Specs dir: /absolute/repo/apps/web/specs   (current output: absolute)
 *     - Tasks path: apps/web/specs/tasks.md        (legacy: repo-root-relative)
 *
 * Current plan writers emit absolute bindings ({{specs_dir}} resolves
 * absolutely); repo-relative and project-relative recordings are legacy
 * forms that remain safely readable. Header path formatting never
 * influences operational directory resolution — this module only verifies
 * plan ownership.
 */
